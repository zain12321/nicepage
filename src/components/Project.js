...
function Project(props) {
	...
	return (
		<div className="ml-3 sm:ml-[50px] sm:pt-6 md:pt-0 lg:pt-8 xl:pt-11  md:ml-[60px] lg:ml-[150px] xl:ml-[132px]">
			<div className="flex flex-col text-[#111111] space-y-5">
				<img
					className="w-[280px] h-[150] sm:h-[550px] sm:w-[530px] 
                md:h-[260px] md:w-[300px] lg:h-[400px] lg:w-[300px] xl:h-[500px] xl:w-[480px] "
					src={image}
					alt=""
				/>
				<div className="items-center text-[16px] space-y-5">
					...
					<div>
						<p className="flex items-center space-x-2 sm:text-[22px] md:text-[17px]">
