...
function ProjectCard() {
  return (
    <div>
           <div className='flex items-center space-x-[10px] pl-3 sm:pl-6  md:pl-6 lg:pl-24 pt-14'>
      ...
      w-[310px] sm:w-[590px] md:w-[900px] pl-4 md:pl-8 lg:pl-24 sm:font-normal 
      ...
      EVERY PROJECT 
         ...
         <div className='pl-4 sm:pl-3 md:pl-6 sm:pt-4 md:pt-0 lg:pl-24 w-[300px] sm:text-[26px] md:text-[16px] sm:w-[520px] md:w-[690px] lg:w-[720px] '>
        ...
        <div className='ml-[5px] md:ml-12 lg:ml-[55px] sm:ml-[25px] oswald font-medium text-[16px] mt-4 text-left '>
