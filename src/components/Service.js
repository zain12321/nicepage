...
function Service() {
	...
	return (
       ...
       lg:grid-cols-2 lg:grid-rows-2  overflow-hidden gap-2 
   mt-2 pl-2 sm:pl-10
   md:pl-12  lg:pl-[125px] xl:pl-[110px] pt-3">
				<div className="w-[250px] h-[150px] sm:h-[200px] sm:w-[580px] md:w-[600px]
          lg:w-[380px] lg:h-[140px]
          xl:w-[560px] xl:h-[160px] text-[#111111] ">
					<div data-aos="fade-zoomIn-played" className="flex space-x-4 
					sm:space-x-9 overflow-hidden ">
						<svg
							fill="#d8ba89"
							className="h-[70px] w-[80px] sm:h-[60px] sm:w-[60px] md:h-[90px] md:w-[80px] xl:h-[48px] xl:w-[48px] lg:h-[70px] lg:w-[80px]"
							viewBox="0 0 60 60"
						>
							<g>
								<path
			...
			oswald	font-medium sm:text-[24px] md:text-[24px] sm:font-semibold md:font-normal 
    text-left text-[#111111]">
								ARCHITECTURE
							</h1>
							<p className="
         
          sans sm:text-[16px] md:text-[16px] pt-6 text-left ">
				...
				<div className="w-[250px] h-[150px]  sm:h-[200px] sm:w-[580px] md:w-[600px]
          lg:w-[370px] lg:h-[140px]
          xl:w-[560px] xl:h-[160px] text-[#111111] ">
					<div data-aos="fade-zoomIn-played" className="flex space-x-4 sm:space-x-9 overflow-hidden ">
						<svg
							fill="#d8ba89"
							className="h-[70px] w-[80px] sm:h-[60px] sm:w-[60px]  md:h-[90px] md:w-[80px] xl:h-[48px] xl:w-[48px] lg:h-[70px] lg:w-[80px]"
							viewBox="0 0 54 54"
						...
						<div className="flex flex-col shrink">
							<h1 className="text-[24px] oswald	font-medium  sm:text-[24px] md:text-[24px] sm:font-semibold md:font-normal 
    text-left text-[#111111]">
								PLANNING
							</h1>
							<p className="
