...
function ServiceCard() {
  return (
    <div className=''>
          <div className='flex items-center space-x-[10px] pl-3 sm:pl-9 md:pl-12 lg:pl-24 pt-14'>
      <img className='h-6 w-6 sm:h-7 sm:w-7 md:h-5 md:w-5 ' src="data:image/png;base64,"
        alt=''
        /><p className='roboto font-bold sm:text-[32px] md:text-[20px]'>Our Services</p>
      </div>
   <div className='grid grid-cols-1 grid-rows-4 lg:grid-cols-2 lg:grid-rows-2 overflow-hidden gap-2 
   mt-2 pl-2 sm:pl-10
   md:pl-12  lg:pl-[90px] pt-3'>
