...
<p className='border-b-8 pt-2 border-[#f1c50e] w-[200px] '></p>
<p className='w-[300px] text-[18px]'>Sample text. Click to select the text box. Click again or double click to start editing the text.</p>
         </div>
    </div>
  )
}
