...
function OneCard() {
  ...
  return (
    ...
    <div className=' w-[300px] sm:w-[500px] mt-6 h-[940px] sm:h-[600px] md:w-[700px] 
    md:h-[500px] lg:h-[400px] 
    lg:w-[930px] xl:w-[1150px]  md:flex justify-between'>
             <div 	data-aos="fade-zoomIn-played" className='bg-[#FFFFFF] w-[290px]
              sm:w-[500px] md:w-[550px] lg:w-[780px] xl:w-[1000px] sm:pt-14 sm:pl-4 
              md:pl-3 lg:pl-8 xl:pl-14'>
                 <p 	data-aos="fade-zoomIn-played" className='w-[240px]
                  sm:w-[430px] md:w-[510px] lg:w-[730px] xl:w-[830px]
           ...
           <div className='bg-[#7c5ddf] w-[290px] sm:h-[100px] sm:w-[500px]
